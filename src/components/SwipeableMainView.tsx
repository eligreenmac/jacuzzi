...
export const TAB_GUIDE_DEFINITIONS = [
  ...
  },
  {
    ...
    subtitle: "מעקב חומרים שנוספו ושליטה במלאי הארון",
    icon: FlaskConical,
    description: "מעקב היסטורי אחר כל החומרים שהוספו לג'קוזי וניהול מלאי הכימיקלים בארון.",
    tips: [
      "תיעוד ומעקב היסטורי מלא אחר כל תוספת חומר, כמות ומינון שבוצעו.",
      "שליטה בכמויות החומרים שנותרו בארון וקבלת התראות לפני סיום המלאי.",
      "רישום מהיר של תוספת חומר יזומה וקישורים ישירים לרכישת חומרים.",
    ],
  },
];
          ...
          >
            ...
            <div className="bg-[#080e14]/90 p-4 sm:p-5 rounded-2xl border border-sky-900/50 space-y-3.5 text-xs sm:text-sm text-slate-200 leading-relaxed relative z-10">
              ...
              <div className="space-y-2.5 text-xs text-slate-300 pt-1 border-t border-sky-900/30">
                ...
                <div className="flex items-start gap-2">
                  <span className="text-sky-400 font-bold shrink-0">🧪</span>
                  <span><strong>כימיקלים ומלאי:</strong> מעקב היסטורי אחר כל החומרים שנוספו לג&apos;קוזי, ניהול מלאי הארון והתראה לפני סיום.</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-sky-400 font-bold shrink-0">🤖</span>
                  <span><strong>מומחה AI והתראות חכמות:</strong> רופא מים AI לאבחון בעיות מים ותקלות, זיהוי כימיקלים בתמונה, אופטימיזציה לשגרות והתראות מותאמות אישית.</span>
                </div>
              </div>
            </div>
