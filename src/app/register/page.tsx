  ...
  return (
    <div className="bg-[#0e1823] border-2 border-sky-500/60 rounded-3xl p-6 sm:p-8 shadow-2xl shadow-sky-950/70 space-y-6 text-right relative overflow-hidden" dir="rtl">
      ...
      <div className="text-center space-y-3 relative z-10">
        ...
        <h1 className="text-2xl sm:text-3xl font-black text-white">הרשמה והצטרפות</h1>
        <p className="text-sky-300 font-semibold text-xs sm:text-sm">הצטרפות מהירה ובטוחה באמצעות חשבון Google</p>
      </div>
