  ...
  try {
    ...
    const newTest = await prisma.waterLog.create({
      data: {
        ...
        waterClarity: waterClarity || "CLEAR",
        waterOdor: waterOdor || "FRESH",
        clarityOdorNotes: clarityOdorNotes || description || null,
        ...
        description: description || clarityOdorNotes || null,
  ...
  try {
    ...
    const updated = await prisma.waterLog.update({
      ...
      data: {
        ...
        waterOdor: waterOdor !== undefined ? waterOdor : undefined,
        clarityOdorNotes: clarityOdorNotes !== undefined ? clarityOdorNotes : (description !== undefined ? description : undefined),
        description: description !== undefined ? description : (clarityOdorNotes !== undefined ? clarityOdorNotes : undefined),
        aiDiagnosis: diagnosis.waterStatusSummary,
        aiRecommendations: JSON.stringify(diagnosis),
      },
    });
