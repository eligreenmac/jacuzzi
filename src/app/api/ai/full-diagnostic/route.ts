  ...
  try {
    ...
    if (latestWaterLog) {
      ...
      latestWaterTestPayload = {
        ...
        totalChlorineRange: (latestWaterLog as any).totalChlorineRange,
        cya: latestWaterLog.cya,
        cyaRange: (latestWaterLog as any).cyaRange,
        salt: latestWaterLog.salt,
        saltRange: (latestWaterLog as any).saltRange,
        waterTemp: latestWaterLog.waterTemp,
        waterTempRange: (latestWaterLog as any).waterTempRange,
        carbonate: (latestWaterLog as any).carbonate,
        carbonateRange: (latestWaterLog as any).carbonateRange,
        nitrate: (latestWaterLog as any).nitrate,
        nitrateRange: (latestWaterLog as any).nitrateRange,
        nitrite: (latestWaterLog as any).nitrite,
        nitriteRange: (latestWaterLog as any).nitriteRange,
        iron: (latestWaterLog as any).iron,
        ironRange: (latestWaterLog as any).ironRange,
        copper: (latestWaterLog as any).copper,
        copperRange: (latestWaterLog as any).copperRange,
        chromium: (latestWaterLog as any).chromium,
        chromiumRange: (latestWaterLog as any).chromiumRange,
        lead: (latestWaterLog as any).lead,
        leadRange: (latestWaterLog as any).leadRange,
        mercury: (latestWaterLog as any).mercury,
        mercuryRange: (latestWaterLog as any).mercuryRange,
        fluoride: (latestWaterLog as any).fluoride,
        fluorideRange: (latestWaterLog as any).fluorideRange,
        extendedMetrics: latestWaterLog.extendedMetrics,
